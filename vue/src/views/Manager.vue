    ...
    <div style="height: 60px; background-color: #fff; display: flex; align-items: center; border-bottom: 1px solid #ddd">
      <div style="flex: 1">
        <div style="padding-left: 20px; display: flex; align-items: center">
          ...
          <div style="font-weight: bold; font-size: 24px; margin-left: 5px" v-if="user.role==='ADMIN'">后台管理系统</div>
          <div style="font-weight: bold; font-size: 24px; margin-left: 5px" v-if="user.role==='TEACHER'">学生成绩管理系统</div>
          <div style="font-weight: bold; font-size: 24px; margin-left: 5px" v-if="user.role==='STUDENT'">学生选课系统</div>
        </div>
      </div>
