...
public interface TeacherMapper {
    ...
    @Update("update student.tbteacher set tno=#{username} ,tname=#{name} ,tsex=#{tsex},tdept=#{tdept},temail=#{temail} where tno=#{username}")
    ...
    @Select("select * from student.tbteacher where tno = #{username}")
    public List<Teacher> selectByTNO(String username);
}
